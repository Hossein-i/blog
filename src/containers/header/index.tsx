  ...
  return (
    <header className="fixed top-0 inset-x-0 w-full md:sticky md:inset-auto md:w-fit md:h-full">
      <div className="p-2 md:h-full">
        <div className="bg-white shadow p-2 rounded-lg flex justify-between items-center md:flex-col md:h-full">
          <div className="flex items-center gap-4 md:flex-col">
            <div>
              <button className="p-4 bg-slate-200 rounded-lg">
          ...
          <div className="hidden md:grid justify-center py-2 w-full bg-slate-200 rounded-lg">
